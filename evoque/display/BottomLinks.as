package evoque.display
{
	...
	public class BottomLinks extends Sprite
	{
		...
		{
			var req:URLRequest = new URLRequest("http://www.landrover.com/cn/zh/lr/");
			navigateToURL(req, "_blank");
		}

		private function goTd(e:MouseEvent):void
		{
			var req:URLRequest = new URLRequest("http://www.landroverchina.com.cn/shijia.html");
			navigateToURL(req, "_blank");
		}

		private function goKmi(e:MouseEvent):void
		{
			var req:URLRequest = new URLRequest("http://www.landroverchina.com.cn/tanchuss.html");
			navigateToURL(req, "_blank");
		}

		private function goDealer(e:MouseEvent):void
		{
			var req:URLRequest = new URLRequest("http://www.landroverchina.com.cn/retailers.asp");
			navigateToURL(req, "_blank");
		}
