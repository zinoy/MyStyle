package evoque.controls
{
	...
	public class LightScrollBar extends Sprite
	{
		private const PADDING:Number = 5;
		private var _rect:Rectangle;
		private var _btn:Sprite;

		public function LightScrollBar(height:Number=128)
		{
			init(height);
		}
		...
		private function init(_height:Number):void
		{
			...
			bar.graphics.beginFill(0xb7d037);
			bar.graphics.drawRect(0, 0, 3, _height);
			bar.graphics.endFill();
			addChildAt(bar, 0);
			bar.x = 1.5;
			
			_btn = new Sprite();
			_btn.graphics.beginFill(0x9cb322);
			_btn.graphics.drawRoundRect(0, 0, 6, 25, 6);
