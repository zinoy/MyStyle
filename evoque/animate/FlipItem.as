package evoque.animate
{
	...
	public class FlipItem extends Sprite
	{
		...
		public function hide(duration:Number=.6):void
		{
			TweenLite.to(_forntside, duration, {alpha:.36, scaleX:0, scaleY:0, ease:Quad.easeOut});
			TweenLite.to(_backside, duration, {alpha:.36, scaleX:0, scaleY:0, ease:Quad.easeOut});
		}
